...
<style>
    .custom-navbar {
        background-color: rgba(15, 23, 42, 0.9) !important; /* Dark Slate Semi-Transparan */
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto align-items-lg-center gap-1 mt-3 mt-lg-0">
        ...
        <li class="nav-item ms-lg-2">
          <a class="nav-link btn-booking" href="#"><i class="bi bi-bag-check-fill me-1"></i> Sewa / Booking</a>
        </li>
      </ul>
    </div>
  </div>
