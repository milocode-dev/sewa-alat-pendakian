...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ route('transaction.store') }}" method="POST">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="list-group">
                                ...
                                @foreach ($items as $alat)
                                    <div class="list-group-item d-flex align-items-center gap-3 py-3" data-item-card
                                        data-nama="{{ $alat->item_name }}" data-harga="{{ $alat->price_per_day }}">

                                        <img src="{{ asset('storage/' . $alat->image) }}" class="rounded-3" width="56"
                                            height="56" style="object-fit:cover" alt="{{ $alat->item_name }}">
                                        ...
                                        <div class="flex-grow-4">
                                            ...
                                            <small class="text-muted">
                                                {{ $alat->category->category_name }}
                                                • Stok {{ $alat->stock }}
                                                • Rp{{ number_format($alat->price_per_day, 0, ',', '.') }}/hari
                                            </small>
                                        ...
                                        <div class="input-group input-group-sm" style="width:130px;">
                                            ...
                                            <input type="number" class="form-control text-center" data-qty-input
                                        ...
                                        <input type="hidden" name="items[{{ $alat->id }}][nama]"
                                            value="{{ $alat->item_name }}">

                                        <input type="hidden" name="items[{{ $alat->id }}][harga]"
                                            value="{{ $alat->price_per_day }}">
                    ...
                    <div class="card shadow-sm rounded-4 mb-4">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted small mb-4">Tentukan tanggal ambil dan kembali alat.</p>
                    ...
                    <!-- ---------- 3. DATA DIRI (Bootstrap Floating Labels) ---------- -->
                    <div class="card shadow-sm rounded-4 mb-4">
                        <div class="card-body p-4">
                            <h5 class="fw-bold mb-1"><i class="bi bi-person-lines-fill text-success me-2"></i>Data Diri
                                Penyewa</h5>
                            <p class="text-muted small mb-4">Pastikan data sesuai KTP untuk verifikasi saat pengambilan
                                alat.</p>

                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" name="nama" id="namaLengkap" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="tel" name="whatsapp" id="noWhatsapp" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" name="email" id="emailAddr" class="form-control"
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="catatan" id="catatan" class="form-control" placeholder="Catatan" style="height: 100px;"></textarea>
                    ...
                    <!-- ---------- 4. METODE PEMBAYARAN (Bootstrap btn-check, no custom JS) ---------- -->
                    <div class="card shadow-sm rounded-4 mb-4">
                        <div class="card-body p-4">
                            <h5 class="fw-bold mb-1"><i class="bi bi-credit-card text-success me-2"></i>Metode Pembayaran
                            </h5>
                            <p class="text-muted small mb-4">Pilih salah satu metode pembayaran deposit.</p>

                            <div class="row g-2">
                                @foreach ([['id' => 'transfer', 'icon' => 'bi-bank', 'label' => 'Transfer Bank'], ['id' => 'ewallet', 'icon' => 'bi-wallet2', 'label' => 'E-Wallet'], ['id' => 'qris', 'icon' => 'bi-qr-code', 'label' => 'QRIS'], ['id' => 'cod', 'icon' => 'bi-shop', 'label' => 'Bayar di Tempat']] as $i => $pay)
                                    <div class="col-6 col-md-3">
                                        <input type="radio" class="btn-check" name="metode_bayar"
                                            id="pay-{{ $pay['id'] }}" value="{{ $pay['id'] }}"
                                            {{ $i === 0 ? 'checked' : '' }} required>
                                        <label class="btn btn-outline-success w-100 py-3" for="pay-{{ $pay['id'] }}">
                                            <i class="bi {{ $pay['icon'] }} d-block fs-4 mb-1"></i>
                                            <span class="small">{{ $pay['label'] }}</span>
                                        </label>
                                    </div>
                                @endforeach
                            </div>
                ...
                <!-- ==================== KOLOM KANAN: RINGKASAN (Bootstrap sticky-top) ==================== -->
                <div class="col-lg-4">
                    <div class="card shadow-sm rounded-4" style="top: 20px;">
                        <div class="card-body p-4">
    ...
    <script>
        // ================== LOGIKA BOOKING (hanya perhitungan, bukan styling) ==================
        ...
        [tanggalAmbil, tanggalKembali].forEach(el => el.addEventListener('change', updateSummary));
